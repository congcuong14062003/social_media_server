...
import { createHeartStory, createStory, deleteStory, listStory, storyById } from "../../controllers/Story/story.controller.js";
...
export default function StoryRouter() {
  ...
  router.post("/create-heart-story/:id", Authentication, Authorization, createHeartStory);
  router.delete("/delete/:id", Authentication, Authorization, deleteStory);
  return router;
}
